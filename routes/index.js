...
router.get('/', function (req, res, next) {
	myContract.methods.auctionNumber_huangzishun().call({ from: hzAccous }).then(function (result) {
		if (result == 0) {
			res.render("first", { accounts: hzAccous })
		} else {
			res.redirect('/first/' + result)
		}
	})
...
router.get('/first/:name', function (req, res, next) {
	...
	myContract.methods.getGoodlist_huangzishun(parseInt(req.params.name)).call({ from: hzAccous }).then(function (result) {
		myContract.methods.highestBid_huangzishun().call({ from: hzAccous }).then(function (result1) {
			myContract.methods.highestBidder_huangzishun().call({ from: hzAccous }).then(function (result2) {
				myContract.methods.getBidderTime_huangzishun().call({ from: hzAccous }).then(function (result3) {
					res.render("index", { Goods1: result, highestBid: result1, highestBidder: result2, time12: result3 })
				})
			})
		})
	})
